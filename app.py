...
def home():
     if request.method == 'POST':
     	...
     	if link2=="N/A":
     	  ...
     	  return render_template("flask_weather_app.html",link2=url1,quantity=quantity,title=title,a=a,title1=title1,price1=price1,url3=url3,quantity3=quantity3,p=stock5,link=link3,stock=stock,link5=link5,price=price,quantity1=quantity1,price3=price3,link6=link6,price4=price4,quantity4=quantity4,stock3=stock3,title4=title4)
